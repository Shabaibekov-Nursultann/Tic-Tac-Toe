...
function cellOnclick() {
    ...
    if (checkWinner(data)) {
        ...
        document.getElementById('roundHistory').innerHTML += `победа ${player} ,</br>`// кайсы оюнчу утса ошол оюнчунун аты тизмекке тушот
        refresha()
        ...
        if (draw) {
            ...
            document.getElementById('roundHistory').innerHTML += `Hичья, </br>`
            refresha()
            roundHistory.push(whoWins.innerHTML)
        }
    }
